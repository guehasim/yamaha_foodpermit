...
<body>
   <div class="page">
        <a href="<?= site_url('makan') ?>" class="btn-back">KEMBALI</a>
        <header>
            <img src="<?= base_url('assets') ?>/admin/login/images/logo.png" alt="logo" width="50">
            <div>
        ...
        <div class="lineinvoice">
            <div>
                <h2>LAPORAN DATA MAKAN MASUK</h2>
            </div>
        </div>
            ...
            <table class="table table-striped table-bordered" cellpadding="2" cellspacing="0" style="">
                <thead>
                    <tr style="background:#dadade;">
                        <th style="padding: 5px; border: 1px solid black;">ID Request</th>
                        ...
                        <th style="padding: 5px; border: 1px solid black;">Jenis Makanan</th>
                        <th style="padding: 5px; border: 1px solid black;">Jumlah Pesanan</th>
                        <th style="padding: 5px; border: 1px solid black;">Supplier</th>
                        <th style="padding: 5px; border: 1px solid black;">Keperluan</th>
                    </tr>
                </thead>
                <tbody>
